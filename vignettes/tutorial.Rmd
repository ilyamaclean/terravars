...
par(mfrow = c(1, 2))
plot(fp_down, col = rev(map.pal("viridis")), main = "Downstream", mar = c(2, 2, 2, 5))
points(pt, pch = 21, bg = "red")
plot(fp_up, col = rev(map.pal("viridis")), main = "Upstream", mar = c(2, 2, 2, 5))
points(pt, pch = 21, bg = "red")
```
...
par(mfrow = c(1, 2))
plot(fp_down_mfd, col = rev(map.pal("viridis")), main = "Downstream", mar = c(2, 2, 2, 5))
points(pt, pch = 21, bg = "red")
plot(fp_up_mfd, col = rev(map.pal("viridis")), main = "Upstream", mar = c(2, 2, 2, 5))
points(pt, pch = 21, bg = "red")
```
...
plot(fp_lake, col = rev(map.pal("viridis")), main = "Catchment of a real lake")
